/*report 60007 "PDC Check Report"
{
    // version NAVW114.00

    DefaultLayout = RDLC;
    PreviewMode = PrintLayout;
    RDLCLayout = 'PDC Objects\Report\PDC Check.rdl';
    Caption = 'PDC Check Report';
    Permissions = TableData 270 = m;

    dataset
    {
        dataitem(VoidGenJnlLine; "PDC Issue")
        {
            ...
            begin
                ...
                PDCCodeunit.VoidPDC(VoidGenJnlLine);
            end;
                                            ...
                                            END ELSE
                                                CASE BalancingType OF
                                                    BalancingType::"G/L Account":
                                                        BEGIN
                                                            DocNo := GenJnlLine2.Code;
                                                            //   ExtDocNo := GenJnlLine2.;
                                                            LineAmount := CurrentLineAmount;
                                                            LineDiscount := 0;
                                                        END;
                                                    BalancingType::Customer:
                    ...
                    begin
                        IF NOT TestPrint THEN BEGIN
                            WITH GenJnlLine DO BEGIN
                                ...
                                CheckLedgEntry.Description := Name;
                ...
                begin
                    IF NOT TestPrint THEN BEGIN
                        IF UseCheckNo <> GenJnlLine."Cheque No." THEN BEGIN
                            ...
                            GenJnlLine3.SETRANGE(code, GenJnlLine.Code);
                        ...
                        IF ApplyMethod <> ApplyMethod::MoreLinesOneEntry THEN BEGIN
                            ...
                            GenJnlLine3.TESTFIELD("No. Series", '');
    ...
    var
        ...
        GenJnlLine2: Record "PDC Issue";
        GenJnlLine3: Record "PDC Issue";
