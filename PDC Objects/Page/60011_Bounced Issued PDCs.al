page 60011 "Bounced Issued PDCs"
{
    // Code           Date        Name        Desc.
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field(Control1000000024; '')
                {
                    CaptionClass = Text19079542;
                    ShowCaption = false;
                    Style = Strong;
                    StyleExpr = TRUE;
                    ApplicationArea = All;
    ...
    var
        ...
        Text19079542: Label 'Cheque Datails';
