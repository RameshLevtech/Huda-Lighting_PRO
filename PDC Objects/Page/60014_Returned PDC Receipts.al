page 60014 "Returned PDC Receipts"
{
    // Code           Date        Name        Desc.
    ...
    SourceTableView = WHERE("Returned/ Not Encashed" = CONST(true),
                            Posted = CONST(true),
                            Bounced = CONST(false));
