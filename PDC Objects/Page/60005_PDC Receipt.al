page 60005 "PDC Receipt"
{
    ...
    SourceTableView = SORTING(Code) WHERE(Posted = FILTER(false), Bounced = FILTER(false), "Returned/ Not Encashed" = FILTER(false));
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Payment Method"; "Payment Method Code")
                {
                    ApplicationArea = All;
                }
    ...
    begin
        WITH PDCReceipt DO BEGIN
            ...
            EVALUATE(DateBounced, BouncedDateText);
    ...
    begin
        WITH PDCReceipt DO BEGIN
            ...
            CLEAR(DateReturned);
            //DateReturnedText := Window1.InputBox('Returned Date:', 'INPUT', '', 50, 50);  //TempMS commented
