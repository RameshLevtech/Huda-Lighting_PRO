report 50123 ReceiptVoucher_LT
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Custom Reports\REPOSITORY\ReceiptVoucher_LT\ReceiptVoucher_LT.rdlc';
    Caption = 'ReceiptVoucher_LT';
    ...
    dataset
    {
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            column(Amount_GenJournalLine; "Gen. Journal Line"."Credit Amount")
            {
            }
            column(No; No)
            {
            ...
            column(DocumentNo2_GenJournalLine; 'Doc No.2')
            {
            }
            ...
            begin
                IF "Gen. Journal Line"."Account Type" = "Gen. Journal Line"."Account Type"::Customer THEN BEGIN
                    Customer_Rec.RESET;
                    Customer_Rec.SETRANGE("No.", "Gen. Journal Line"."Account No.");
                ...
                TotalAmt += "Gen. Journal Line"."Credit Amount";
            ...
            begin
                // "Gen. Journal Line".SETFILTER("Gen. Journal Line"."Source Code", '%1', 'CASHRECJNL');
